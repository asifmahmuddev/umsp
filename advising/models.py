...
class AssignedCourse(models.Model):
    slug = models.SlugField(verbose_name="ID", max_length=255, unique=True, default='')
    current_semester = models.ForeignKey('Create_Semester', on_delete=models.CASCADE, default=False)
    for_dept = models.ForeignKey('Department', verbose_name="Department", on_delete=models.SET_NULL, null= True)
    course = models.ForeignKey('Course', on_delete=models.CASCADE)
    section = models.IntegerField(blank=False, null=False)
    Time_WeekDay = models.CharField(max_length=255)
    Room = models.CharField(verbose_name="Room No", max_length=255)
    available = models.IntegerField(verbose_name="Available Seats", blank=False, null=False)
    taken = models.IntegerField(verbose_name="Taken Seats", default=0)
    has_lab = models.BooleanField(default=False)
    l_Time_WeekDay = models.CharField(verbose_name="Lab Time WeekDay", max_length=255, null=True, blank=True)
    l_Room = models.CharField(verbose_name="Lab Room No", max_length=255, null=True, blank=True)
...
class TakeCourse(models.Model):
    ...
    Room = models.CharField(verbose_name="Room No", max_length=255, default=False)
    has_lab = models.BooleanField(default=False)
    l_Time_WeekDay = models.CharField(verbose_name="Lab Time WeekDay", max_length=255, null=True, blank=True)
    l_Room = models.CharField(verbose_name="Lab Room No", max_length=255, null=True, blank=True)
